    ...
    public class WlanClient : IDisposable
    {
        ...
        public class WlanInterface
        {
            ...
            private static Wlan.WlanAvailableNetwork[] ConvertAvailableNetworkListPtr(IntPtr availNetListPtr)
            {
                ...
                var availNetListIt = availNetListPtr.ToInt64() + Marshal.SizeOf(typeof(Wlan.WlanAvailableNetworkListHeader));
                var availNets = new Wlan.WlanAvailableNetwork[availNetListHeader.numberOfItems];
                for (var i = 0; i < availNetListHeader.numberOfItems; ++i)
                {
            ...
            private static Wlan.WlanBssEntry[] ConvertBssListPtr(IntPtr bssListPtr)
            {
                ...
                var bssListIt = bssListPtr.ToInt64() + Marshal.SizeOf(typeof(Wlan.WlanBssListHeader));
                var bssEntries = new Wlan.WlanBssEntry[bssListHeader.numberOfItems];
                for (var i = 0; i < bssListHeader.numberOfItems; ++i)
                {
            ...
            public Wlan.WlanProfileInfo[] GetProfiles()
            {
                ...
                try
                {
                    ...
                    var profileInfos = new Wlan.WlanProfileInfo[header.numberOfItems];
                    var profileListIterator = profileListPtr.ToInt64() + Marshal.SizeOf(header);
        ...
        public WlanInterface[] Interfaces {
            get {
                ...
                try
                {
                    ...
                    var listIterator = ifaceList.ToInt64() + Marshal.SizeOf(header);
